...
.testimonial-items1 {
  ...
  animation: itemsAlternate 30s 10s infinite both;
}

@keyframes itemsAlternate {
  0% {
    opacity: 100%;
  }
...
.testimonial-items1 .description-expanded:hover {
  animation: expandAppear 2s 1s 1 forwards;
}

@keyframes expandAppear {
  0% {
    display: none;
    opacity: 0%;
  }
